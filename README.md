...
### **Awesome ReasonML** [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 495,060 | 🐛 100 | 📅 2026-06-30

A collection of awesome things regarding Reason/OCaml ecosystem. Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 495,060 | 🐛 100 | 📅 2026-06-30 list thing. Feel free to improve this list.
...
* [reason-react](https://github.com/reasonml/reason-react) ⭐ 3,266 | 🐛 34 | 🌐 Reason | 📅 2026-06-15 - React.js bindings
...
* [melange-json](https://github.com/melange-community/melange-json) ⭐ 25 | 🐛 21 | 🌐 OCaml | 📅 2026-08-10 - Compositional JSON encode/decode library for Melange

#### Server

* [Dream](https://github.com/aantron/dream) ⭐ 1,872 | 🐛 109 | 🌐 OCaml | 📅 2026-05-23 - Tidy, feature-complete Web framework
* [server-reason-react](https://github.com/ml-in-barcelona/server-reason-react) ⭐ 174 | 🐛 6 | 🌐 OCaml | 📅 2026-08-07 - Server render Reason React components with OCaml natively
* [html\_of\_jsx](https://github.com/davesnx/html_of_jsx) ⭐ 53 | 🐛 0 | 🌐 OCaml | 📅 2026-08-06 - Render HTML with JSX
...
* [melange-fest](https://github.com/ahrefs/melange-fest) ⭐ 15 | 🐛 0 | 🌐 OCaml | 📅 2026-08-10 - A minimal test framework for Melange using Node test runner
...
* [ocaml-lsp](https://github.com/ocaml/ocaml-lsp) ⭐ 910 | 🐛 152 | 🌐 OCaml | 📅 2026-08-12 - OCaml Language Server Protocol implementation
* [vscode-ocaml-platform](https://github.com/ocamllabs/vscode-ocaml-platform) ⭐ 385 | 🐛 61 | 🌐 OCaml | 📅 2026-08-11 - Visual Studio Code extension for ReasonML and OCaml
...
* [Coronate](https://github.com/johnridesabike/coronate) ⭐ 175 | 🐛 8 | 🌐 ReScript | 📅 2026-07-25 - A Swiss-style chess tournament manager for the web and desktop, written with ReasonReact. [(web demo)](https://johnridesa.bike/coronate/)
